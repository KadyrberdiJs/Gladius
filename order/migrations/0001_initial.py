# Generated by Django 5.1.7 on 2025-10-07 10:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('parfumes', '0004_alter_productvariant_options_alter_product_discount_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='parfumes.product', verbose_name='Продукт')),
            ],
            options={
